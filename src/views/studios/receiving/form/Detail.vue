<template>
  <div>
    <el-form :model="form" :rules="rules" ref="form" label-width="100px" :size="'mini'">
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :label="'维修单号'" prop="filmName">
            <el-input v-model="form.filmName" ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="'工程师'" prop="filmName">
            <el-input v-model="form.filmName" ></el-input>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :label="'产品条码'" prop="filmName">
            <el-input v-model="form.filmName" ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="'产品名称'" prop="filmName">
            <el-input v-model="form.filmName" ></el-input>
          </el-form-item>
        </el-col>
      </el-row> <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :label="'型号'" prop="filmName">
            <el-input v-model="form.filmName" ></el-input>
          </el-form-item>
        </el-col>
        <el-col :span="12">
      ...
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :label="'配件费用'" prop="filmName">
            <el-input-number v-model="form.filmName" :min="1"></el-input-number>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="'工时费'" prop="filmName">
            <el-input-number v-model="form.filmName" :min="1"></el-input-number>
          </el-form-item>
        </el-col>
      </el-row>
      <el-row :gutter="20">
        <el-col :span="12">
          <el-form-item :label="'物流费用'" prop="filmName">
            <el-input-number v-model="form.filmName" :min="1"></el-input-number>
          </el-form-item>
        </el-col>
        <el-col :span="12">
          <el-form-item :label="'优惠后金额'" prop="filmName">
            <el-input-number v-model="form.filmName" :min="1"></el-input-number>
          </el-form-item>
        </el-col>
      </el-row>
